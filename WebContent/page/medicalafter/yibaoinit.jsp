...
<body style="padding: 10px 10px 10px 10px;">
	<table align="center" width="100%" class="t1" border="0"
		...
		<tr>
			<th colspan="10"><s:property value="medicalafterDTO.membername" />基本信息</th>
		</tr>
		<tr>
			<td width="11%">家庭编号</td>
			<td width="14%"><s:property value="medicalafterDTO.familyno" />&nbsp;</td>
			<td width="11%">姓名</td>
			<td width="14%"><s:property value="medicalafterDTO.membername" />&nbsp;</td>
			<td width="11%">身份证号码</td>
			<td width="14%"><s:property value="medicalafterDTO.paperid" />&nbsp;</td>
			<td width="11%">医保卡号</td>
			<td width="14%"><s:property value="medicalafterDTO.ssn" />&nbsp;</td>
		</tr>
	</table>
	<br/>
	...
	&nbsp;&nbsp;
		医院名称：<s:select id="hid" cssStyle="width: 650px;height:20px" name="medicalafterDTO.hospitalid" list="ybhospitals" listKey="hospitalid" listValue="hospitalname"></s:select>
		<br/>
		&nbsp;&nbsp;
		入院时间：<s:property value="medicalafterDTO.begintimeval" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		出院时间：<s:property value="medicalafterDTO.endtimeval" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		救助类型：
		<s:if test="medicalafterDTO.medicaltype==1">住院</s:if>
		<s:elseif test="medicalafterDTO.medicaltype==2">门诊</s:elseif>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="button" style="width: 150px;" onclick="queryYBXX()">查&nbsp;&nbsp;&nbsp;&nbsp;询</button>
		<s:hidden id="ssn" name="medicalafterDTO.ssn"></s:hidden>
		<s:hidden name="medicalafterDTO.begintimeval"></s:hidden>
		<s:hidden name="medicalafterDTO.endtimeval"></s:hidden>
		<s:hidden name="medicalafterDTO.medicaltype"></s:hidden>
	</s:form>
	<br/>
	<table align="center" width="100%" class="t1" border="0"
		cellpadding="0" cellspacing="0">
